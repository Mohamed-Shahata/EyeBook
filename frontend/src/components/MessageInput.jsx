			...
			<form onSubmit={handleSendMessage} style={{ flex: 95 }}>
				<InputGroup>
					<Input
						...
						value={messageText}
					/>
					<InputRightElement transition={"ease 0.3s"} _hover={{bg:"gray.light",color:"white"}} onClick={handleSendMessage} cursor={"pointer"}>
						<IoSendSharp />
					</InputRightElement>
				</InputGroup>
			</form>
			<Flex transition={"ease 0.3s"} cursor={"pointer"} _hover={{bg:"gray.light",color:"white",borderRadius:"50%"}}p={2}>
